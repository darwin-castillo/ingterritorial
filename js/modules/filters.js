function applyFilters(arrayParam) {
    ...
    if (findGetParameter('past') === 'true') {
        console.log("implentando filtro procesos desactualizado...");


        arrayParam = $.grep(arrayParam, function (v) {
            return (typeof v.fecha_fin_ejec_contrato !== 'undefined') && (getEpoch(v.fecha_fin_ejec_contrato) >= (new Date().getTime() / 1000));
